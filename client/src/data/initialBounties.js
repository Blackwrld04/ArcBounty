export const CREATOR_CATEGORIES = [
  ...
  { id: 'DESIGN', label: '🎨 DESIGN & 3D', color: '#664c88', textColor: '#ffffff' },
  { id: 'VIDEO', label: '🎬 VIDEO & MOTION', color: '#e9a13f', textColor: '#000000' },
  { id: 'WRITING', label: '✍️ WRITING & THREADS', color: '#acc6e9', textColor: '#000000' },
  { id: 'MEMES', label: '🐸 MEMES & SOCIAL', color: '#ffcc6f', textColor: '#000000' },
  { id: 'DEV', label: '💻 CODE & APPS', color: '#2f578c', textColor: '#ffffff' },
  { id: 'TRANSLATION', label: '🌐 TRANSLATION', color: '#c0827a', textColor: '#ffffff' },
];
...
export const INITIAL_BOUNTIES = [
  {
    ...
    isAiEligible: true,
    description: 'Create an iconic 3D mascot embodying Arc L1\'s institutional foundation (BlackRock, ICE, DTCC) and sub-second speed. Deliverable: Blender GLTF + 15 expressive Telegram & Discord stickers.'
  },
  {
    id: 'bounty-arc-002',
